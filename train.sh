...
python train.py --train-stage 2 \
      ...
      --valid_dir /scratch/users/astar/ares/ma_yi/output/vallex/ \
      --lang zh \
      --num-epochs 40 --start-epoch 4 --start-batch 0 --accumulate-grad-steps 4 \
      --exp-dir /scratch/users/astar/ares/ma_yi/output/vallex/exp/stage-2